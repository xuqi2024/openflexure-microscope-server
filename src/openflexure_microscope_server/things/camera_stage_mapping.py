...
class CameraStageMapper(Thing):
    ...
    def calibrate_xy(
        ...
        """Move the microscope's stage in Y and X, to calibrate its relationship to the camera

        This performs two 1d calibrations in y and then x, then combines their results.
        """

        # Shorter axis of image first, as it's more likely to fail
